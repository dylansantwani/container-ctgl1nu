...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ctgl1nu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ctgl1nu.containers.anotherwebservice.com/
...
```
git clone git@github.com:dylansantwani/container-ctgl1nu.git
cd container-ctgl1nu
```
...
```
docker attach container-ctgl1nu
```
